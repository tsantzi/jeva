...
/**
 * All-zeroes function evaluator
 * 
 * @author Nikolaos Chatzinikolaou
 */
public class EvaluatorZero implements Evaluator
{
	private static final double VAR_MIN = 0;
	private static final double VAR_MAX = 1;
